"use client"
import { Backdrop, Box, Button, IconButton, InputAdornment, TextField, Typography } from '@mui/material'
    ...
    return (
        <>
            ...
            <Backdrop sx={{
                ...
                <CreatePostModel setIsCreatePostModelOpen={setIsCreatePostModelOpen} />
            </Backdrop>
        </>
    )
})
